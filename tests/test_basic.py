...
from ligrad.main import gd_transit_model, vsini2omega

time = np.linspace(-0.1, 0.1, 320)

flux = gd_transit_model(t_vals = time, orbital_period = 5.0, st_mass = 1.0, st_mean_radius = 1.0, 
                               ...
                               rp_rs = 0.1, obs_wavelength=800e-9, pl_grid=2)
...
# flux2 = gd_transit_model(t_vals = time, orbital_period = 5.0, st_mass = 1.0, st_mean_radius = 1.0, 
